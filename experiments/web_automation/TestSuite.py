...
from FooterLinkVerification import FooterLinkVerificationTest
...
footer_link_verification_test = unittest.TestLoader().loadTestsFromTestCase(FooterLinkVerificationTest)
...
test_suite = unittest.TestSuite([form_submission_test, link_verification_test, solutions_link_verification_test,
                                 resources_link_verification_test, footer_link_verification_test])
